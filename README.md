...
This project organized my weekly class schedule using Outlook Calendar with repeating events, color coding, and school-week formatting. It helps manage time effectively and visually simplifies my academic worklaod.
...
![](Screenshot 2025-12-07 194555.png)
...
A multi-worksheet Excel workbook analyzing thrift inventory using formuals, conditional formatting, and data visualization. Inlcudes profit calculations, category color-coding, and a customaized budget tracker to organize income, expenses, and savings goals.
